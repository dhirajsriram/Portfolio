      ...
      >
        ...
        <Work
          ...
          duties={[
            ...
            "Responsible for building applications optimized for <span className='bold-text'>speed,accessibility and responsiveness</span>",
            ...
            "Ensuring that the code is <span className='bold-text'reusable and scalable</span> for any future development."
          ]}
        ...
        <Work
          ...
          duties={[
            ...
            "Lead the design and development of Inutive apllications which satisfy <span className='bold-text'>ease-of-use and promotes user interaction</span>",
            "Work with QA to ensure that the <span className='bold-text'>applications meet desired objectives</span>",
