            ...
            <div className="mt-5 profile-img">
              ...
              <div className="who-is">
                ...
                <p className="About-me">
                    I work as a UI developer for <a className="bold-text" href="https://saucelabs.com/"> Saucelabs, GmbH</a> in Berlin, DE. I am a guy that has a serious passion for designing user-friendly, efficient, reliable and intutive User-Interfaces. 
                </p>
              </div>
            </div>
          </div>
